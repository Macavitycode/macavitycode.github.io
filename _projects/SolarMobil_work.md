---
layout: project
title:  "SolarMobil Automation Work"
---

[SolarMobil](https://www.solarmobilmanipal.in/) is a student project under
...
I have made a similar model without using the exact same design and algorithm
for public [here]({{ '/_projects/Cone_following_with_ackermann_drive.md' | relative_url }}).
...
the on screen area usage of each of the cones once identified (again, check [here]({{ '/_projects/Cone_following_with_ackermann_drive.md' | relative_url }})).
...
A more in depth view of the system is [here]({{ '/SolarDocs' }}).
